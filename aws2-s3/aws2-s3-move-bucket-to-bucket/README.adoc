...
> cd <ckc_project> 
> mvn clean package
> cp <ckc_project>/connectors/camel-aws2-s3-kafka-connector/target/camel-aws2-s3-kafka-connector-0.7.1.fuse-800003-redhat-00001-SNAPSHOT-package.zip /home/oscerd/connectors/
> cd /home/oscerd/connectors/
> unzip camel-aws2-s3-kafka-connector-0.7.1.fuse-800003-redhat-00001-SNAPSHOT-package.zip
```
