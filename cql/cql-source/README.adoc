...
Define value for property 'version' 1.0-SNAPSHOT: : 0.5.0.fuse-jdk11-800014-redhat-00001
...
version: 0.5.0.fuse-jdk11-800014-redhat-00001
...
[INFO] Parameter: version, Value: 0.5.0.fuse-jdk11-800014-redhat-00001
...
> cp /home/oscerd/playground/cql-extended/target/cql-extended-0.5.0.fuse-jdk11-800014-redhat-00001-package.zip .
> unzip cql-extended-0.5.0.fuse-jdk11-800014-redhat-00001-package.zip
```
